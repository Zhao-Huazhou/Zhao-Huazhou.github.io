...
就从最朴素的 AI 三要素开始谈起——数据、算法、算力：

- 数据：需要投入人力成本、时间成本，来对企业内部的数据，以及互联网上公开的数据进行爬取、清洗；
- 算法：需要招聘专业的算法工程师，并投入研发周期与算力设施，来提升算法能力；
- 算力：显卡硬件是实实在在的开销。

**而 AI 对企业产生的实际收益是什么呢？几乎看不太清**。
...
- 数据（用于模型的后训练，对其业务领域）
- 知识（人的经验与工作流的文档化，SKILL）
- 评测（衡量 AI 数字员工的 KPI，端到端业务价值评估）

## AI，请你帮我赚钱

我曾经在一篇随记里提过：[AI 应用的第一性原理，或许是输出有业务价值的 Token]({{< ref "notes/ai-first-principles-commercial-token-output/index.md" >}})。

而现在，我可以提出一个更加直截了当的观点——

AI 应用的第一性原理是：**AI，请你帮我赚钱**。