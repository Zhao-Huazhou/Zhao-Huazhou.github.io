...
> 这十个关键转变，尤其可作为我所定义的 [AI 应用层]({{< ref "notes/ai-product-manager-three-levels/index.md" >}}#ai-application-layer) 产品经理，向 [AI 工程化层]({{< ref "notes/ai-product-manager-three-levels/index.md" >}}#ai-engineering-layer) 过渡时的参考坐标。
